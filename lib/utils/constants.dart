import 'package:nunyaexam/features/wallet/models/payoutMethod.dart';

final String appName = "Nunyaexam";
final String packageName = "com.epahubb.nunyaexam";
...
final String initialSelectedCountryCode = 'GH';
...
// final String databaseUrl = "https://demo.hammackbank.com";
final String databaseUrl = "http://3.80.196.24";
...
final String getBeceQuestionUrl = "${baseUrl}get_bece_questions";
final String getWassceQuestionUrl = "${baseUrl}get_wassce_questions";
final String getCambridgeOLevelQuestionUrl =
    "${baseUrl}get_cambridgeOLevel_questions";
final String getCambridgeALevelQuestionUrl =
    "${baseUrl}get_cambridgeALevel_questions";
final String getTofelQuestionUrl = "${baseUrl}get_tofel_questions";
final String getSatQuestionUrl = "${baseUrl}get_sat_questions";
...
final int questionDurationInSeconds = 60;
