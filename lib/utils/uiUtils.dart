...
import 'package:nunyaexam/ui/widgets/alreadyLoggedInDialog.dart';

import 'package:nunyaexam/ui/widgets/errorMessageDialog.dart';
...
class UiUtils {
  ...
  static String getCategoryTypeNumberFromQuizType(QuizTypes quizType) {
    ...
    // bece 6,  wassce = 7 cambridge o level = 10 cambridge A level = 11
    if (quizType == QuizTypes.cambridgeALevel) {
      return "11";
    }
    if (quizType == QuizTypes.cambridgeOLevel) {
      return "10";
    }
    if (quizType == QuizTypes.sat) {
      return "9";
    }
    if (quizType == QuizTypes.tofel) {
      return "8";
    }
    if (quizType == QuizTypes.wassce) {
      return "7";
    }
    if (quizType == QuizTypes.bece) {
      return "6";
    }
