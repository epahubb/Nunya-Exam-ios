...
String beceKey = "bece";
String wassceKey = "wassce";
String cambridgeOLevelKey = "cambridgeOLevel";
String cambridgeALevelKey = "cambridgeALevel";
String tofelKey = "tofel";
String satKey = "sat";
String ieltsKey = "ielts";
...
String desBeceKey = "desBece";
String desWassceKey = "desWassce";
String desCambridgeOLevelKey = "desCambridgeOLevel";
String desCambridgeALevelKey = "desCambridgeALevel";
String desTofelKey = "desTofel";
String desSatKey = "desSat";
String desIeltsKey = "desIelts";
...
String alreadyLoggedInKey = "alreadyLoggedIn";
String pleaseGiveCameraPermissionKey = "pleaseGiveCameraPermission";

String pleaseGivePickImagePermissionKey = "pleaseGivePickImagePermission";

String askedCameraNotAvailableKey = "askedCameraNotAvailable";

String retakeKey = "retake";
