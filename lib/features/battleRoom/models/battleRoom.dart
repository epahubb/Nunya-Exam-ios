...
class BattleRoom {
  ...
  final UserBattleRoomDetails?
      user2; //it will be in use for multiUserBattleRoom
  final UserBattleRoomDetails?
      user3; //it will be in use for multiUserBattleRoom
  final UserBattleRoomDetails?
      user4; //it will be in use for multiUserBattleRoom
