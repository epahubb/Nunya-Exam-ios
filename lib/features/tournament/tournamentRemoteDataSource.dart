...
import 'package:nunyaexam/utils/internetConnectivity.dart';
...
class TournamentRemoteDataSource {
  ...
  Future<List<DocumentSnapshot>> searchTournament(
  ...
  Future<List<DocumentSnapshot>> searchSemiFinal(
    ...
    try {
      ...
      return FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        Tournament tournament =
            Tournament.fromDocumentSnapshot(documentSnapshot);
    ...
    try {
      ...
      return FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        TournamentBattle tournamentBattle =
            TournamentBattle.fromDocumentSnapshot(documentSnapshot);
