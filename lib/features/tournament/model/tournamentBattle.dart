...
class TournamentBattle {
  ...
  static TournamentBattle fromDocumentSnapshot(
    ...
    return TournamentBattle(
      ...
      battleType:
          convertTournamentBattleTypeFromStringToEnum(data['battleType']),
  ...
  static String convertTournamentBattleTypeFromEnumToString(
  ...
  static TournamentBattleType convertTournamentBattleTypeFromStringToEnum(
      String tournamentBattleType) {
