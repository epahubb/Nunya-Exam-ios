...
class Tournament {
  ...
  static Tournament fromJson(Map<String, dynamic> data) {
    return Tournament(
      ...
      players: data['players'] == null
          ? ([] as List<TournamentPlayerDetails>)
          : (data['players'] as List)
              .map((e) => TournamentPlayerDetails.fromJson(Map.from(e)))
              .toList(),
    );
  }
  ...
  static String convertStatusFromEnumToString(
  ...
  static TournamentStatus convertStatusFromStringToEnum(
