import 'dart:convert';
import 'dart:io';
import 'package:nunyaexam/utils/apiBodyParameterLabels.dart';
import 'package:http/http.dart' as http;
import 'package:nunyaexam/features/quiz/quizException.dart';
import 'package:nunyaexam/utils/apiUtils.dart';
...
// GET MATH QUESTIONS
  ...
  Future<List> getBeceQuestions(
    ...
    try {
      ...
      final response = await http.post(Uri.parse(getBeceQuestionUrl),
          body: body, headers: await ApiUtils.getHeaders());
  ...
  // GET WASSCE QUESTIONS
  Future<List> getWassceQuestions(
      {required String type, required String id}) async {
    try {
      Map<String, String> body = {
        accessValueKey: accessValue,
      ...
      final response = await http.post(Uri.parse(getWassceQuestionUrl),
          body: body, headers: await ApiUtils.getHeaders());
  ...
  // GET CAMBRIDGE O LEVEL QUESTIONS
  Future<List> getCambridgeOLevelQuestions(
      {required String type, required String id}) async {
    try {
      Map<String, String> body = {
        accessValueKey: accessValue,
      ...
      final response = await http.post(Uri.parse(getCambridgeOLevelQuestionUrl),
          body: body, headers: await ApiUtils.getHeaders());
  ...
  // GET CAMBRIDGE O LEVEL QUESTIONS
  Future<List> getCambridgeALevelQuestions(
      {required String type, required String id}) async {
    try {
      Map<String, String> body = {
        accessValueKey: accessValue,
      ...
      final response = await http.post(Uri.parse(getCambridgeALevelQuestionUrl),
          body: body, headers: await ApiUtils.getHeaders());
...
// GET TOFEL QUESTIONS
  Future<List> getTofelQuestions(
    ...
    try {
      ...
      final response = await http.post(Uri.parse(getTofelQuestionUrl),
          body: body, headers: await ApiUtils.getHeaders());
...
// GET CAMBRIDGE O LEVEL QUESTIONS
  Future<List> getSatQuestions(
    ...
    try {
      ...
      final response = await http.post(Uri.parse(getSatQuestionUrl),
          body: body, headers: await ApiUtils.getHeaders());
