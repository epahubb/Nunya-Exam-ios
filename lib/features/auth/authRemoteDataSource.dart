  ...
  Future<Map<String, dynamic>> addUser(
    ...
    try {
      ...
      final body = {
        ...
        // firebaseIdKey: "G1thaSiA43WYx29dOXmUd6jqUWS2",
        typeKey: type,
        nameKey: name,
        emailKey: email ?? "",
        profileKey: profile ?? "",
      ...
      final response = await http
          .post(Uri.parse("http://3.80.196.24/Api/user_signup"), body: body);
...
//signIn using phone number
  ...
  Future<Map<String, dynamic>> signInUser(
    ...
    try {
      ...
      //   }
      // } 
      else if (authProvider == CubitAuth.AuthProvider.email) {
        UserCredential userCredential =
            await signInWithEmailAndPassword(email!, password!);

        result['user'] = userCredential.user!;
        result['isNewUser'] = userCredential.additionalUserInfo!.isNewUser;
      } else if (authProvider == CubitAuth.AuthProvider.apple) {
...
//   }
  ...
  Future<void> signOut(CubitAuth.AuthProvider? authProvider) async {
    ...
    // } 
    // else if (CubitAuth.AuthProvider.apple == CubitAuth.AuthProvider.apple) {}
  }
}
