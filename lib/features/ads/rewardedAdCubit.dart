...
class RewardedAdCubit extends Cubit<RewardedAdState> {
  ...
  // Future<void> _createFacebookRewardedAd(BuildContext context,
  //     {required Function onFbRewardAdCompleted}) async {
  ...
  void createUnityRewardsAd() {
    UnityAds.load(
        ...
        onFailed: (placementId, error, message) => emit(RewardedAdFailure()));
  }
