...
import 'package:nunyaexam/ui/widgets/badgesIconContainer.dart';
...
class _BadgesScreenState extends State<BadgesScreen> {
  ...
  void showBadgeDetails(BuildContext context, CustomBadge.Badge badge) {
  ...
  List<CustomBadge.Badge> _organizedBadges(List<CustomBadge.Badge> badges) {
    List<CustomBadge.Badge> lockedBadges =
        badges.where((element) => element.status == "0").toList();
    List<CustomBadge.Badge> unlockedBadges = badges
  ...
  Widget _buildBadges(BuildContext context) {
    return BlocConsumer<BadgesCubit, BadgesState>(
      ...
      builder: (context, state) {
        ...
        final List<CustomBadge.Badge> badges =
