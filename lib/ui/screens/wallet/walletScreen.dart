...
import 'package:nunyaexam/features/wallet/cubits/paymentRequestCubit.dart';
import 'package:nunyaexam/features/wallet/cubits/transactionsCubit.dart';
import 'package:nunyaexam/features/wallet/models/paymentRequest.dart';
import 'package:nunyaexam/features/wallet/walletRepository.dart';
import 'package:nunyaexam/ui/screens/wallet/widgets/redeemAmountRequestBottomSheetContainer.dart';
          ...
          CustomRoundedButton(
            ...
            onTap: () {
              ...
              if (double.parse(
                ...
                UiUtils.setSnackbar(
                    "${AppLocalization.of(context)!.getTranslatedValues(minimumRedeemableAmountKey)} $payoutRequestCurrency${_minimumReedemableAmount()} ",
                    context,
                    false);
                return;
              }
