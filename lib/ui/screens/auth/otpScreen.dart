...
import 'package:nunyaexam/features/auth/cubits/signInCubit.dart';
import 'package:nunyaexam/features/profileManagement/cubits/userDetailsCubit.dart';
import 'package:nunyaexam/ui/screens/auth/widgets/resendOtpTimerContainer.dart';
import 'package:nunyaexam/ui/screens/auth/widgets/termsAndCondition.dart';
  ...
  static Route<dynamic> route(RouteSettings routeSettings) {
    return CupertinoPageRoute(
        builder: (_) => BlocProvider<SignInCubit>(
              child: OtpScreen(),
              create: (_) => SignInCubit(CustomAuth.AuthRepository()),
            ));
  }
}
    ...
    return BlocConsumer<SignInCubit, SignInState>(
      ...
      listener: (context, state) {
        if (state is SignInSuccess) {
          //update auth details
          context.read<CubitAuth.AuthCubit>().updateAuthDetails(
