...
import 'package:nunyaexam/utils/validators.dart';
          ...
          child: AlertDialog(
            ...
            actions: [
              TextButton(
                ...
                child: Text(
                    state is UpdateUserDetailInProgress
                        ? AppLocalization.of(context)!
                            .getTranslatedValues("updatingLbl")!
                        : AppLocalization.of(context)!
                            .getTranslatedValues("updateLbl")!,
                    style: TextStyle(
